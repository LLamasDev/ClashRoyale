        ...
        try:
            ...
            while True:
                try:
                    ...
                    diccionario = {'comun': (5,20,50,150,400,1000,2000,4000,8000,15000,35000,75000,100000), 'especial': (50,150,400,1000,2000,4000,8000,15000,35000,75000,100000), 'epica': (400,2000,4000,8000,15000,35000,75000,100000), 'legendaria': (5000,15000,35000,75000,100000)}
