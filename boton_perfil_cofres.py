    ...
    if usuario != 'None':
        try:
            ...
            for numeros, cofre in diccionario.items():
                ...
                elif cofre[1] == 'Gold Crate':
                    if idioma == 'es':
                        respuesta += '\n' + str(cofre[0]) + ' para una caja de oro.'
                    else:
                        respuesta += '\n' + str(cofre[0]) + ' for a gold Crate.'
                elif cofre[1] == 'Overflowing Gold Crate':
                    if idioma == 'es':
                        respuesta += '\n' + str(cofre[0]) + ' para una caja de oro abundante.'
                    else:
                        respuesta += '\n' + str(cofre[0]) + ' for an overflowing Gold Crate.'
                elif cofre[1] == 'Plentiful Gold Crate':
                    if idioma == 'es':
                        respuesta += '\n' + str(cofre[0]) + ' para una caja de oro desbordante.'
                    else:
                        respuesta += '\n' + str(cofre[0]) + ' for a plentiful Gold Crate.'
                elif cofre[1] == 'Ova':
                    if idioma == 'es':
                        respuesta += '\n' + str(cofre[0]) + ' para una caja de oro abundante.'
                    else:
